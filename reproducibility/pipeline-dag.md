...
| COHORT-E | Build eICU validation cohort | GOV | BigQuery execution of `14_create_eicu_external_validation_cohort.sql` | eICU-CRD 2.0 authorized tables | Restricted eICU derived tables | Frozen variable mapping | Not rerun in public-only review |
| VALIDATE-E | Apply frozen transport and sensitivity analyses | ANALYSIS-M, COHORT-E | `python scripts/15_run_eicu_external_validation.py` | Frozen MIMIC parameters; restricted eICU features | Restricted labels; aggregate validation outputs | Seed 42; nearest frozen centroid | Existing aggregate report; clean rerun pending |
...
| RELEASE | Audit public reproducibility package | All prior stages | Manual release checklist | Public code/docs and cleared aggregates | Tagged release | Secret/disclosure/reproducibility checks | In progress |

## Manual stages

| Stage ID | Decision | Reviewer | Inputs | Recorded outcome |
| :--- | :--- | :--- | :--- | :--- |
| GOV | Restrict this review to public and aggregate-review artifacts | Codex + author confirmation pending | Repository metadata and governance rules | `PROCEED_PUBLIC_ONLY` |
| ESTIMAND | Descriptive same-hospital association versus 48 h landmark | Authors | Protocol, SAP, review findings | Pending |
