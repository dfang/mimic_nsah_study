...
- Table 1 至少包含年龄、性别、种族、入院类型、保险、aneurysm evidence level、动脉瘤诊断/处置证据、早期贫血、输血、ICU/住院时长、total GCS、GCS motor、GCS grade、sodium、ePVS、troponin、SAPS III/SOFA 和 8 个主聚类变量。total GCS 和 GCS grade 可作为描述或补充材料变量，不作为主聚类输入。
