...
Among 1,186 MIMIC ICU admissions from 1,173 patients, P1 had mild neuro-systemic impairment (n=694), P2 had severe neurological impairment with limited systemic dysfunction (n=384), and P3 had severe neurological impairment with multisystem dysfunction (n=108). In-hospital mortality was 6.34%, 32.55%, and 61.11%, respectively. Compared with P1, adjusted odds ratios for death were 7.59 (95% CI 5.07-11.36) for P2 and 21.21 (95% CI 12.08-37.26) for P3. Anemia was not independently associated with mortality after phenotype adjustment. In eICU (N=843), transported phenotypes retained the mortality ordering (5.4%, 25.8%, and 42.7%).
...
Adult ICU admissions with NSAH were eligible if ICU length of stay was at least 24 h and no more than two of eight core physiological variables were missing. MIMIC admissions were identified using ICD-9 code 430 or ICD-10 I60.x codes. eICU stays were identified using ICD-9 code 430, admission diagnosis text containing subarachnoid hemorrhage, or diagnosis table entries consistent with NSAH. The cross-database NSAH identification algorithm was not formally validated against manual chart review. Admissions with traumatic subarachnoid hemorrhage, multiple ICU stays during the index hospitalization, or red blood cell transfusion within 24 h meeting the study-specific operational exclusion (>=5 units) were excluded. Separate eligible admissions from the same patient were retained. This study-specific restriction was intended to limit distortion of baseline hemoglobin, hemodynamic, and coagulation signals; it was not treated as an externally validated massive-transfusion threshold.
...
The primary outcome was in-hospital mortality. Secondary outcomes included ICU mortality, length of stay, early anemia, and red blood cell transfusion. Because a death could occur during the 0-48 h feature window, mortality analyses describe same-hospital associations rather than prognosis from a 48 h landmark. Multivariable logistic regression assessed the association between phenotype and hospital mortality. The primary model adjusted for age, sex, admission type, NSAH evidence level, aneurysm diagnosis, and early anemia. A process-of-care model also included nimodipine, vasopressors, mechanical ventilation, red blood cell transfusion, renal replacement therapy, EVD/ICP monitoring, and fluid balance. We interpreted process variables as exploratory severity and treatment-selection markers, not causal treatment effects. Cox models were used as sensitivity analyses for time to in-hospital death. Bootstrap resampling and prediction cross-validation were grouped by patient; every bootstrap iteration refitted imputation, scaling, PCA, and K-means. Sensitivity analyses included complete-case, strict aneurysm, ICU stay >=48 h, 0-24 h window, inclusion of the massive-transfusion exclusion group, no recorded red blood cell transfusion, hemoglobin-free, INR-free, K=4, and 200-bootstrap stability analyses.

## Results

### Cohort and phenotype structure

The MIMIC derivation cohort included 1,186 ICU admissions from 1,173 adults. Overall in-hospital mortality was 19.81%, early anemia occurred in 26.56%, and red blood cell transfusion within 48 h occurred in 2.02%. Missingness was low in the derivation cohort: maximum INR was missing in 5.48%, and all other core features were missing in <=0.08%.
...
The eICU validation cohort included 843 patients. Fixed transport assigned 540 patients to P1, 221 to P2, and 82 to P3. Hospital mortality increased from 5.4% in P1 to 25.8% in P2 and 42.7% in P3. ICU mortality, early anemia, and red blood cell transfusion also increased across transported phenotypes.
...
Independent de novo K-means clustering in eICU recovered ordered mortality differences, but patient-level agreement with transported labels was low (adjusted Rand index 0.0005). This result supports transportability of the observed mortality ordering, not exact replication of cluster boundaries across databases.

### Robustness

Sensitivity analyses preserved the ordered mortality pattern. Patient-grouped, full-pipeline bootstrap stability was high, with mean adjusted Rand index 0.855 (median 0.866; out-of-bag mean 0.858) across 200 resamples. The ICU-stay >=48 h and no-red-cell-transfusion sensitivities had adjusted Rand indices of 0.860 and 0.927 against the primary labels, respectively. No eligible admission met the massive-transfusion exclusion, so the include-all sensitivity was identical to the primary cohort (adjusted Rand index 1.000). Hemoglobin-free clustering preserved phenotype-mortality separation and supported the conclusion that the anemia result was not driven only by the inclusion of hemoglobin in the primary clustering model.
