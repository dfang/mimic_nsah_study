...
![队列筛选和分析框架](20260711/figures/fig1_cohort_flowchart.png)
**图 1.** 队列筛选和分析框架。人数来自 BigQuery 中间队列流程表。下方模块概括 MIMIC 表型推导和 eICU 冰冻迁移。

![表型热图](20260711/figures/fig2_primary_log_pca_heatmap.png)
...
![结局和贫血梯度](20260711/figures/fig3_outcomes_anemia.png)
...
![外部验证严重程度评分](20260711/figures/fig4_external_severity_validation.png)
...
![预测性能](20260711/figures/fig5_prediction_performance.png)
